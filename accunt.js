const apiUrl = "http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders?api_key=a2973cdd-d303-48f2-a6b6-78ff07878f95"; // URL API для получения заказов
...
async function editOrder(orderId) {
    ...
    try {
        ...
        const response = await fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderId}?api_key=a2973cdd-d303-48f2-a6b6-78ff07878f95`);
        if (!response.ok) {
...
async function saveOrderChanges(event) {
    ...
    try {
        ...
        const response = await fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderIdToEdit}?api_key=a2973cdd-d303-48f2-a6b6-78ff07878f95`, {
            method: "PUT",
...
async function deleteOrder() {
    ...
    try {
        ...
        const response = await fetch(`http://cat-facts-api.std-900.ist.mospolytech.ru/api/orders/${orderIdToDelete}?api_key=a2973cdd-d303-48f2-a6b6-78ff07878f95`, 
        { method: "DELETE" });
